...
impl From<NonAutoPlacement> for Byml {
    fn from(value: NonAutoPlacement) -> Self {
        ...
        map.insert(
            "NonAutoPlacementAnimal".into(),
            value.non_auto_placement_animal.unwrap().into(),
        );
        map.insert(
            "NonAutoPlacementBird".into(),
            value.non_auto_placement_bird.unwrap().into(),
        );
        map.insert(
            "NonAutoPlacementEnemy".into(),
            value.non_auto_placement_enemy.unwrap().into(),
        );
        map.insert(
            "NonAutoPlacementFish".into(),
            value.non_auto_placement_fish.unwrap().into(),
        );
        map.insert(
            "NonAutoPlacementInsect".into(),
            value.non_auto_placement_insect.unwrap().into(),
        );
        map.insert(
            "NonAutoPlacementMaterial".into(),
            value.non_auto_placement_material.unwrap().into(),
        );
        map.insert(
            "NonEnemySearchPlayer".into(),
            value.non_enemy_search_player.unwrap().into(),
        );
